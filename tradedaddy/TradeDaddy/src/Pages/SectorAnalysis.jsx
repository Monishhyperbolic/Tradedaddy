...
const SECTORS = [
  { id:'it',          label:'💻 Information Technology', color:'#6C5CE7',
    etf:'NIFTYIT.NS',
    stocks:[{s:'TCS.NS',n:'TCS'},{s:'INFY.NS',n:'Infosys'},{s:'HCLTECH.NS',n:'HCL Tech'},{s:'WIPRO.NS',n:'Wipro'},{s:'TECHM.NS',n:'Tech Mahindra'}] },
  ...
  { id:'auto',        label:'🚗 Automobile', color:'#FDCB6E',
    etf:'NIFTYAUTO.NS',
    stocks:[{s:'MARUTI.NS',n:'Maruti'},{s:'BAJAJ-AUTO.NS',n:'Bajaj Auto'},{s:'HEROMOTOCO.NS',n:'Hero MotoCorp'},{s:'EICHERMOT.NS',n:'Eicher'},{s:'MOTHERSON.NS',n:'Motherson'}] },
